...
export class InputHandler {
  ...
  private handleKeyDown(event: KeyboardEvent) {
    switch (event.code) {
      case "ArrowLeft":
      case "KeyA":
      case "KeyJ": // Alternative left key
      ...
      case "ArrowRight":
      case "KeyD":
      case "KeyL": // Alternative right key
        event.preventDefault();
        this.inputState.right = true;
        this.notifyInputChange();
        break;
      case "Space": // Space for quick mouse control toggle
      case "KeyM": // M for mouse control
        event.preventDefault();
        this.inputState.isDragging = !this.inputState.isDragging;
        this.notifyInputChange();
        break;
    }
  }
