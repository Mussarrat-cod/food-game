...
export class PhysicsEngine {
  private readonly BASE_FALLING_SPEED = 100; // pixels per second - reduced from 180
  private readonly SPAWN_INTERVAL = 1500; // milliseconds - increased from 833 (slower spawn rate)
